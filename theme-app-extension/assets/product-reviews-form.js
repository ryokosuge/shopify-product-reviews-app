...
(function () {
  ...
  // utility function that simplifies creation of new iput + label html nodes group
  ...
  function initWriteReview({ target }) {
    ...
    const element = target.parentNode.classList.contains(
      "prapp-summary__no-reviews",
    )
      ? target.parentNode
      : target;
